...
# 2. Clean up any existing demo agent pod
...
# 4. Run kill script in background
...
# 5. Wait for the pod to be recreated (restartPolicy: OnFailure)
...
# 6. Check if annotation was patched
...
# 7. Re-deploy agent to show recovery
